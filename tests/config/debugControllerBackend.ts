...
export interface DebugControllerChannel {
  ...
  setReportStateChanged(params: any): Promise<any>;
  setRecorderState(params: any): Promise<any>;
  [key: string]: any;
}

export namespace channels {
  export type DebugControllerChannel = import('./debugControllerBackend').DebugControllerChannel;
}
